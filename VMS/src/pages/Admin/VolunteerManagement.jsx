  ...
  const [volunteers, setVolunteers] = useState([
    {
      ...
      task: {
        ...
        description: "Modernize company website UI/UX",
    ...
    },
    {
      ...
      task: {
        ...
        description: "Design social media recruitment strategy",
        status: "Pending Approval"
      }
    }
  ]);
  ...
  const filteredVolunteers = useMemo(() => {
    return volunteers.filter((volunteer) => {
      ...
      const matchesSkills = filterCriteria.skills
        ? volunteer.skills.includes(filterCriteria.skills)
        : true;
              ...
              {filteredVolunteers.map((volunteer) => (
                ...
                >
                  <td className="px-6 py-4 flex items-center">
                    ...
                    <span className="font-medium text-lg">{volunteer.name}</span>
                  </td>
          ...
          <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
            ...
            >
              ...
              <h2 className="text-3xl font-semibold mb-4">
                {selectedVolunteer.task.name}
              </h2>
              <p className="text-sm text-gray-700 mb-6">
                {selectedVolunteer.task.description}
              </p>
