...
function Dashboard() {
  ...
  const fetchData = async () => {
    const fetchedTasks = [
      { id: 1, name: "Task 1", description: "Complete task 1", skillsRequired: "Skill A", status: "assigned", completed: false, hoursLogged: 3 },
      { id: 2, name: "Task 2", description: "Complete task 2", skillsRequired: "Skill B", status: "pending", completed: false, hoursLogged: 5 }
    ];
    const fetchedEvents = [
      { id: 1, name: "Event 1", description: "Description of Event 1", date: "2025-02-10", tasksAvailable: ["Stage Preparation", "Task B"] },
    ];
        ...
        <div className="space-y-8 bg-white/10 backdrop-blur-lg rounded-2xl p-6">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-purple-600/20 p-4 rounded-lg">
              ...
              <p className="text-3xl font-bold text-white">{totalHoursLogged} hrs</p>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-6">
            {events.map((event) => (
              <div key={event.id} className="border-b pb-6 last:border-b-0">
                <div className="flex justify-between items-center">
                  <div>
                    <h3 className="font-semibold text-2xl text-white">{event.name}</h3>
